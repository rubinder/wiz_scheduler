const en = {
  ...
  approvedSchedules: {
    ...
    readOnlyNotice: "Read-only — past the 30-day edit window.",
    savedWithWarnings: "Saved, with warnings",
    deletedWithWarnings: "Deleted, with warnings",
    warningAlreadyBookedTitle: "Double-booked",
    warningAlreadyBookedBody: "This employee is already scheduled for an overlapping shift.",
    warningNoAvailabilityTitle: "No availability on file",
    warningNoAvailabilityBody: "This employee has no recorded availability covering this shift.",
    warningAlreadyExportedTitle: "Already exported",
    warningAlreadyExportedBody: "This schedule was already exported; the external system may now be out of date.",
    shiftLockedTitle: "Shift locked",
    shiftLockedBody: "An employee has already checked in against this shift, so it can no longer be edited.",
    scheduleLockedTitle: "Schedule locked",
    scheduleLockedBody: "{name} is currently editing this schedule. Try again shortly.",
    invalidEdit: "This edit could not be applied. Nothing was changed.",
  },
  ...
  planBanner: {
    ...
    reasonScheduleLimitReached: "The free plan covers one week per location per month, and every location has used it. The allowance resets at the start of next month — upgrade to remove it.",
    usage: "{employeeCount} of {employeeLimit} employees · {locationCount} of {locationLimit} locations",
    usageGenerations: " · {generationCount} of {generationLimit} locations scheduled this month",
