const pcm = {
  ...
  approvedSchedules: {
    ...
    readOnlyNotice: "Na read-only — the 30-day edit window don pass.",
    savedWithWarnings: "E don save, but e get warnings",
    deletedWithWarnings: "E don delete, but e get warnings",
    warningAlreadyBookedTitle: "Double booking",
    warningAlreadyBookedBody: "Dis worker already get one shift wey dey overlap dis one.",
    warningNoAvailabilityTitle: "No availability record",
    warningNoAvailabilityBody: "Dis worker no get any availability record wey cover dis shift.",
    warningAlreadyExportedTitle: "E don already export",
    warningAlreadyExportedBody: "Dis schedule don already export; the outside system fit don old now.",
    shiftLockedTitle: "Shift don lock",
    shiftLockedBody: "One worker don already check in for dis shift, so dem no fit edit am again.",
    scheduleLockedTitle: "Schedule don lock",
    scheduleLockedBody: "{name} dey edit dis schedule right now. Try again small time.",
    invalidEdit: "Dis edit no fit apply. Nothing no change.",
  },
  ...
  schedule: {
    ...
    purchaseModalBody: "Credit dey pay for AI Generate and for schedules wey pass the 50 wey dey included every month. We go charge packs to the card wey dey your subscription.",
    packButton: "Buy {amount}",
    autoReloadOptIn: "Auto-reload this amount if my balance finish",
    purchaseDeclined: "Dem decline your card. Update am for Manage billing then try again.",
    purchaseNoCard: "No card dey file. Add one for Manage billing, then try again.",
    purchaseOnHold: "Billing dey on hold after payment wey fail. Try the payment again first.",
    purchaseSuccess: "Credits don add.",
    creditsExhaustedMsg: "AI Generate dey run on credit wey you don pay before. Your balance don empty — buy pack make you fit continue.",
    redirectingToPayment: "Redirecting...",
    schedulesUsed: "Schedules this month",
    scheduleFreeTierUsed: "Free tier exhausted",
    scheduleQuotaExhaustedMsg: "You don use the 50 schedules wey dey included this month. Extra schedules go pay from the same credit balance — buy pack make you fit continue.",
    autoReloadTitle: "Auto-Reload",
    autoReloadDescription: "E dey optional. If your credit balance go below the threshold, we go charge your saved card the refill amount. E off by default; na only charge wey you ask for we go do.",
  ...
  landing: {
    ...
    pricePerMonth: "/ month",
    basePlanDesc: "Base subscription per ownership group. E include 50 schedules for month, 0.5 GB storage and 1K employees.",
    ...
    normalStrategiesNote: "Rotation, Max Hours and Random scheduling dey always included. AI Generate dey run on prepaid credit packs.",
    aiScheduling: "AI Scheduling",
    included: "Included",
    overage: "Overage",
    aiOverageNote: "Claude Sonnet 5 token cost ($2/M in, $10/M out) at 130%, e dey debit from prepaid packs of $10, $25 or $50.",
    schedules: "Schedules",
    ...
    inputsHardHeading: "E dey enforce always",
    inputsSoftHeading: "Dem weight am from 0 to 1. Once e reach 1.0, preference dey become rule.",
    inputAvailabilityTitle: "Employee availability",
    inputAvailabilityDesc: "Shifts go land only inside di windows wey each employee give. If no availability dey file, e no go ever schedule am. Hours wey don already book for anoda location for di same run, dem dey hold am.",
    inputRolesTitle: "Roles and skill levels",
    inputRolesDesc: "Employee must hold di shift role, or one wey equal am. Higher skill levels dey favored when plenty people qualify.",
    inputHourRestrictionsTitle: "Hour Restrictions",
    inputHourRestrictionsDesc: "Weekly hour cap for each employee, wey dey hold across every location for di same run.",
    inputDayRulesTitle: "Day Rules",
    inputDayRulesDesc: "Blackout ranges wey dey repeat per day of di week. Scheduler no go ever put shift across am.",
    inputMinRestTitle: "Minimum rest",
    inputMinRestDesc: "Per-location gap between shifts for different days, so nobody go close and open sharp sharp.",
    inputAssociationTitle: "Employee Association",
    inputAssociationDesc: "Cannot-work-together pairs, dem no go ever put am for di same shift. Must-work-together, nice-to-have, and prefer-apart pairs dey steer who go dey picked.",
    inputDayPrefsTitle: "Day Wey E Like",
    inputDayPrefsDesc: "Which days of di week each employee like.",
    inputHourRangeTitle: "Time Range Wey E Like",
    inputHourRangeDesc: "Which time of day each employee like. Shift dey count if at least half of am fall inside di range.",
    inputFreqCapsTitle: "How-Many-Time Limit",
    inputFreqCapsDesc: "How many times per week employee dey work inside one given hour range.",
    inputsTemplatesNote: "Shift templates and specific-date overrides dey define wetin need fill. Dem go re-validate every draft after generation, and any shift wey go against soft preference, dem go flag am for review.",
    inputsNotYet: "No dey consider yet: pay rates, overtime premiums, seniority. Minimum rest na di only labor-law rule wey dey built in.",
