const fr = {
  ...
  approvedSchedules: {
    ...
    readOnlyNotice: "Lecture seule — la fenêtre de modification de 30 jours est dépassée.",
    savedWithWarnings: "Enregistré, avec des avertissements",
    deletedWithWarnings: "Supprimé, avec des avertissements",
    warningAlreadyBookedTitle: "Double réservation",
    warningAlreadyBookedBody: "Cet employé est déjà programmé sur un quart qui se chevauche.",
    warningNoAvailabilityTitle: "Aucune disponibilité enregistrée",
    warningNoAvailabilityBody: "Cet employé n'a aucune disponibilité enregistrée couvrant ce quart.",
    warningAlreadyExportedTitle: "Déjà exporté",
    warningAlreadyExportedBody: "Ce planning a déjà été exporté ; le système externe peut maintenant être désynchronisé.",
    shiftLockedTitle: "Quart verrouillé",
    shiftLockedBody: "Un employé a déjà pointé pour ce quart, il ne peut donc plus être modifié.",
    scheduleLockedTitle: "Planning verrouillé",
    scheduleLockedBody: "{name} modifie actuellement ce planning. Réessayez dans un instant.",
    invalidEdit: "Cette modification n'a pas pu être appliquée. Rien n'a changé.",
  },
  ...
  schedule: {
    ...
    balanceLabel: "solde",
    includedThisMonth: "inclus ce mois-ci",
    purchaseModalTitle: "Crédits IA",
    purchaseModalBody: "Les crédits paient la génération IA et les plannings au-delà des 50 inclus chaque mois. Les forfaits sont facturés à la carte de votre abonnement.",
    packButton: "Acheter {amount}",
    autoReloadOptIn: "Recharger automatiquement ce montant quand mon solde est épuisé",
    purchaseDeclined: "Votre carte a été refusée. Mettez-la à jour dans Manage billing et réessayez.",
    purchaseNoCard: "Aucune carte enregistrée. Ajoutez-en une dans Manage billing, puis réessayez.",
    purchaseOnHold: "La facturation est suspendue après un paiement échoué. Réessayez d'abord le paiement.",
    purchaseSuccess: "Crédits ajoutés.",
    creditsExhaustedMsg: "La génération IA fonctionne avec des crédits prépayés. Votre solde est vide — achetez un forfait pour continuer.",
    redirectingToPayment: "Redirecting...",
    schedulesUsed: "Schedules this month",
    scheduleFreeTierUsed: "Free tier exhausted",
    scheduleQuotaExhaustedMsg: "Vous avez utilisé les 50 plannings inclus ce mois-ci. Les plannings supplémentaires sont payés sur le même solde de crédits — achetez un forfait pour continuer.",
    autoReloadTitle: "Recharge automatique",
    autoReloadDescription: "Optionnel. Lorsque votre solde de crédits passe sous le seuil, nous facturons le montant de recharge à votre carte enregistrée. Désactivé par défaut ; chaque prélèvement est un prélèvement que vous avez demandé.",
  ...
  landing: {
    ...
    pricePerMonth: "/ mois",
    basePlanDesc: "Abonnement de base par groupe de propriété. Inclut 50 plannings par mois, 0.5 Go de stockage et 1K employés.",
    aiCredits: "Packs de crédits AI",
    aiPackFrom: "À partir de $10",
    compSchedules: "Plannings offerts / mois",
    storageIncluded: "Stockage inclus",
    employeesIncluded: "Employés inclus",
    normalStrategiesNote: "Rotation, Max Hours et Random sont toujours inclus. La génération AI fonctionne avec des packs de crédits prépayés.",
    aiScheduling: "Planification AI",
    included: "Inclus",
    overage: "Dépassement",
    aiOverageNote: "Coût des tokens Claude Sonnet 5 ($2/M en entrée, $10/M en sortie) majoré de 130%, débité des packs prépayés de $10, $25 ou $50.",
    schedules: "Plannings",
    ...
    exampleAICost: "$1.95 sur les crédits",
    ...
    inputsHardHeading: "Toujours appliqué",
    inputsSoftHeading: "Pondéré de 0 à 1. À 1,0, une préférence devient une règle.",
    inputAvailabilityTitle: "Disponibilité des employés",
    inputAvailabilityDesc: "Les postes ne s'insèrent que dans les créneaux indiqués par chaque employé. L'absence de disponibilité enregistrée signifie qu'il ne sera jamais planifié. Les heures déjà réservées sur un autre site dans la même exécution sont retenues.",
    inputRolesTitle: "Rôles et niveaux de compétence",
    inputRolesDesc: "Un employé doit occuper le rôle du poste, ou un rôle équivalent. Les niveaux de compétence supérieurs sont favorisés lorsque plusieurs personnes sont qualifiées.",
    inputHourRestrictionsTitle: "Hour Restrictions",
    inputHourRestrictionsDesc: "Un plafond hebdomadaire d'heures par employé, maintenu sur tous les sites au sein de la même exécution.",
    inputDayRulesTitle: "Day Rules",
    inputDayRulesDesc: "Des plages d'indisponibilité récurrentes par jour de la semaine. Le planificateur n'y place jamais de poste.",
    inputMinRestTitle: "Repos minimum",
    inputMinRestDesc: "Un écart par site entre les postes sur des jours différents, pour que personne ne ferme puis n'ouvre.",
    inputAssociationTitle: "Employee Association",
    inputAssociationDesc: "Les paires qui ne peuvent pas travailler ensemble ne sont jamais placées sur le même poste. Les paires qui doivent travailler ensemble, celles qui le devraient de préférence et celles qui préfèrent être séparées orientent qui est choisi.",
    inputDayPrefsTitle: "Préférences de Jour",
    inputDayPrefsDesc: "Quels jours de la semaine chaque employé préfère.",
    inputHourRangeTitle: "Préférences d'Horaire",
    inputHourRangeDesc: "Quels moments de la journée chaque employé préfère. Un poste compte lorsqu'au moins la moitié tombe dans la plage.",
    inputFreqCapsTitle: "Limites de Fréquence",
    inputFreqCapsDesc: "Combien de fois par semaine un employé travaille dans une plage horaire donnée.",
    inputsTemplatesNote: "Les modèles de poste et les dérogations pour dates spécifiques définissent ce qui doit être couvert. Chaque brouillon est revalidé après la génération, et tout poste allant à l'encontre d'une préférence souple est signalé pour révision.",
    inputsNotYet: "Pas encore pris en compte : taux de salaire, majorations pour heures supplémentaires, ancienneté. Le repos minimum est la seule règle du droit du travail intégrée.",
