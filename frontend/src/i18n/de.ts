const de = {
  ...
  approvedSchedules: {
    ...
    editTitle: "Schicht bearbeiten",
    readOnlyNotice: "Schreibgeschützt — das 30-tägige Bearbeitungsfenster ist abgelaufen.",
    savedWithWarnings: "Gespeichert, mit Warnungen",
    deletedWithWarnings: "Gelöscht, mit Warnungen",
    warningAlreadyBookedTitle: "Doppelbuchung",
    warningAlreadyBookedBody: "Dieser Mitarbeiter ist bereits für eine sich überschneidende Schicht eingeteilt.",
    warningNoAvailabilityTitle: "Keine Verfügbarkeit hinterlegt",
    warningNoAvailabilityBody: "Für diesen Mitarbeiter ist keine Verfügbarkeit hinterlegt, die diese Schicht abdeckt.",
    warningAlreadyExportedTitle: "Bereits exportiert",
    warningAlreadyExportedBody: "Dieser Plan wurde bereits exportiert; das externe System ist jetzt möglicherweise nicht mehr aktuell.",
    shiftLockedTitle: "Schicht gesperrt",
    shiftLockedBody: "Ein Mitarbeiter hat sich bereits für diese Schicht eingecheckt, daher kann sie nicht mehr bearbeitet werden.",
    scheduleLockedTitle: "Plan gesperrt",
    scheduleLockedBody: "{name} bearbeitet diesen Plan gerade. Versuchen Sie es in Kürze erneut.",
    invalidEdit: "Diese Änderung konnte nicht angewendet werden. Es wurde nichts geändert.",
  },
  ...
  schedule: {
    ...
    includedThisMonth: "diesen Monat enthalten",
    purchaseModalTitle: "KI-Guthaben",
    purchaseModalBody: "Guthaben bezahlt die KI-Generierung und Dienstpläne über die im Monat enthaltenen 50 hinaus. Pakete werden der Karte deines Abonnements belastet.",
    packButton: "{amount} kaufen",
    autoReloadOptIn: "Diesen Betrag automatisch nachladen, wenn mein Guthaben aufgebraucht ist",
    purchaseDeclined: "Deine Karte wurde abgelehnt. Aktualisiere sie unter Manage billing und versuche es erneut.",
    purchaseNoCard: "Keine Karte hinterlegt. Füge eine unter Manage billing hinzu und versuche es erneut.",
    purchaseOnHold: "Die Abrechnung ist nach einer fehlgeschlagenen Zahlung pausiert. Versuche zuerst die Zahlung erneut.",
    purchaseSuccess: "Guthaben hinzugefügt.",
    creditsExhaustedMsg: "Die KI-Generierung läuft auf vorausbezahltem Guthaben. Dein Guthaben ist leer — kaufe ein Paket, um fortzufahren.",
    redirectingToPayment: "Redirecting...",
    schedulesUsed: "Schedules this month",
    scheduleFreeTierUsed: "Free tier exhausted",
    scheduleQuotaExhaustedMsg: "Du hast die 50 in diesem Monat enthaltenen Dienstpläne aufgebraucht. Zusätzliche Dienstpläne werden aus demselben Guthaben bezahlt — kaufe ein Paket, um fortzufahren.",
    autoReloadTitle: "Auto-Aufladung",
    autoReloadDescription: "Optional. Wenn dein Guthaben unter den Schwellenwert fällt, belasten wir deine gespeicherte Karte mit dem Aufladebetrag. Standardmäßig deaktiviert; jede Belastung geschieht nur auf deinen Wunsch.",
  ...
  landing: {
    ...
    pricePerMonth: "/ Monat",
    basePlanDesc: "Basis-Abonnement pro Eigentümergruppe. Inklusive 50 Zeitplänen pro Monat, 0.5 GB Speicher und 1K Mitarbeitern.",
    aiCredits: "AI-Guthabenpakete",
    aiPackFrom: "Ab $10",
    compSchedules: "Inklusive Dienstpläne / Monat",
    storageIncluded: "Speicher inklusive",
    employeesIncluded: "Mitarbeiter inklusive",
    normalStrategiesNote: "Rotation, Max Hours und Random sind immer enthalten. AI-Generierung läuft auf vorausbezahlten Guthabenpaketen.",
    ...
    exampleAICost: "$1.95 aus Guthaben",
    ...
    inputsHardHeading: "Immer durchgesetzt",
    inputsSoftHeading: "Gewichtet von 0 bis 1. Bei 1,0 wird eine Präferenz zur Regel.",
    inputAvailabilityTitle: "Mitarbeiterverfügbarkeit",
    inputAvailabilityDesc: "Schichten fallen nur in die Zeitfenster, die jeder Mitarbeiter angegeben hat. Keine hinterlegte Verfügbarkeit bedeutet, dass nie eingeplant wird. Bereits an einem anderen Standort im selben Lauf gebuchte Stunden werden vorgemerkt.",
    inputRolesTitle: "Rollen und Fähigkeitsstufen",
    inputRolesDesc: "Ein Mitarbeiter muss die Rolle der Schicht innehaben, oder eine gleichwertige. Höhere Fähigkeitsstufen werden bevorzugt, wenn mehrere Personen infrage kommen.",
    inputHourRestrictionsTitle: "Hour Restrictions",
    inputHourRestrictionsDesc: "Eine wöchentliche Stundenobergrenze pro Mitarbeiter, die über alle Standorte im selben Lauf hinweg eingehalten wird.",
    inputDayRulesTitle: "Day Rules",
    inputDayRulesDesc: "Wiederkehrende Sperrzeiten pro Wochentag. Der Planer legt nie eine Schicht über eine solche.",
    inputMinRestTitle: "Mindestruhezeit",
    inputMinRestDesc: "Ein standortbezogener Abstand zwischen Schichten an verschiedenen Tagen, damit niemand schließt und dann wieder öffnet.",
    inputAssociationTitle: "Employee Association",
    inputAssociationDesc: "Paare, die nicht zusammenarbeiten dürfen, werden nie in dieselbe Schicht gesetzt. Paare, die zusammenarbeiten müssen, gerne zusammenarbeiten oder lieber getrennt bleiben, steuern, wer ausgewählt wird.",
    inputDayPrefsTitle: "Tagespräferenzen",
    inputDayPrefsDesc: "Welche Wochentage jeder Mitarbeiter bevorzugt.",
    inputHourRangeTitle: "Zeitraum-Präferenzen",
    inputHourRangeDesc: "Welche Tageszeiten jeder Mitarbeiter bevorzugt. Eine Schicht zählt, wenn mindestens die Hälfte davon in den Zeitraum fällt.",
    inputFreqCapsTitle: "Häufigkeitsgrenzen",
    inputFreqCapsDesc: "Wie oft pro Woche ein Mitarbeiter innerhalb eines bestimmten Zeitraums arbeitet.",
    inputsTemplatesNote: "Schichtvorlagen und datumsspezifische Überschreibungen legen fest, was besetzt werden muss. Jeder Entwurf wird nach der Erstellung erneut geprüft, und jede Schicht, die einer weichen Präferenz widersprach, wird zur Überprüfung markiert.",
    inputsNotYet: "Noch nicht berücksichtigt: Lohnsätze, Überstundenzuschläge, Betriebszugehörigkeit. Die Mindestruhezeit ist die einzige integrierte arbeitsrechtliche Regel.",
