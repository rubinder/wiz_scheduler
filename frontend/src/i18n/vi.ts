const vi = {
  ...
  schedule: {
    ...
    currentBalance: "Số dư tín dụng đã mua",
    creditAmount: "Credit amount",
    purchase: "Purchase",
    redirectingToPayment: "Redirecting...",
    schedulesUsed: "Schedules this month",
    scheduleFreeTierUsed: "Free tier exhausted",
    scheduleQuotaExhaustedMsg: "Số lần tạo lịch miễn phí của bạn đã hết trong tháng này. Tính năng tự động nạp sẽ trừ tiền vào thẻ đã lưu để nạp lại số dư khi nó xuống dưới ngưỡng.",
    autoReloadTitle: "Tự động nạp",
    autoReloadDescription: "Khi số dư AI/lịch của bạn xuống dưới ngưỡng, chúng tôi sẽ tự động trừ thẻ để nạp lại. Tắt để tạm dừng tạo bằng AI khi số dư cạn kiệt.",
