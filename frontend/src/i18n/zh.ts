const zh = {
  ...
  approvedSchedules: {
    ...
    nextMonth: "下个月",
    editTitle: "编辑班次",
    readOnlyNotice: "只读 — 已超过30天的编辑窗口。",
    savedWithWarnings: "已保存，但有警告",
    deletedWithWarnings: "已删除，但有警告",
    warningAlreadyBookedTitle: "重复排班",
    warningAlreadyBookedBody: "该员工已被安排了时间重叠的班次。",
    warningNoAvailabilityTitle: "无可用时间记录",
    warningNoAvailabilityBody: "该员工没有覆盖此班次的可用时间记录。",
    warningAlreadyExportedTitle: "已导出",
    warningAlreadyExportedBody: "此排班已导出；外部系统的数据可能已经过时。",
    shiftLockedTitle: "班次已锁定",
    shiftLockedBody: "员工已针对此班次签到，无法再编辑。",
    scheduleLockedTitle: "排班已锁定",
    scheduleLockedBody: "{name} 正在编辑此排班，请稍后重试。",
    invalidEdit: "无法应用此编辑，未做任何更改。",
  },
  ...
  schedule: {
    ...
    balanceLabel: "余额",
    includedThisMonth: "本月已包含",
    purchaseModalTitle: "AI 积分",
    purchaseModalBody: "积分用于支付 AI 生成费用，以及超出每月包含的 50 次的排班。积分包会向你订阅使用的银行卡收费。",
    packButton: "购买 {amount}",
    autoReloadOptIn: "余额用完时自动充值此金额",
    purchaseDeclined: "你的银行卡被拒绝。请在 Manage billing 中更新后重试。",
    purchaseNoCard: "没有保存的银行卡。请在 Manage billing 中添加一张，然后重试。",
    purchaseOnHold: "付款失败后账单已被暂停。请先重试付款。",
    purchaseSuccess: "积分已添加。",
    creditsExhaustedMsg: "AI 生成使用预付积分。你的余额已用完 — 购买积分包以继续。",
    redirectingToPayment: "Redirecting...",
    schedulesUsed: "Schedules this month",
    scheduleFreeTierUsed: "Free tier exhausted",
    scheduleQuotaExhaustedMsg: "你本月已用完包含的 50 次排班。额外排班从同一积分余额中扣除 — 购买积分包以继续。",
    autoReloadTitle: "自动充值",
    autoReloadDescription: "可选。当你的积分余额低于阈值时，我们会向你保存的银行卡收取充值金额。默认关闭；每一次扣款都是你主动请求的。",
  ...
  landing: {
    ...
    allInOnePlan: "全能套餐",
    pricePerMonth: "/ 月",
    basePlanDesc: "每个所有权组的基础订阅。包含每月 50 个排班、0.5 GB 存储和 1K 名员工。",
    aiCredits: "AI 积分包",
    aiPackFrom: "$10 起",
    compSchedules: "免费排班 / 月",
    storageIncluded: "含存储空间",
    employeesIncluded: "含员工数",
    normalStrategiesNote: "Rotation、Max Hours 和 Random 排班始终包含。AI 生成基于预付积分包运行。",
    aiScheduling: "AI 排班",
    included: "已包含",
    overage: "超额",
    aiOverageNote: "Claude Sonnet 5 的 token 成本（输入 $2/M，输出 $10/M）加价 130%，从 $10、$25 或 $50 的预付积分包中扣除。",
    schedules: "排班",
    ...
    inputsHardHeading: "始终强制执行",
    inputsSoftHeading: "权重从 0 到 1。达到 1.0 时，偏好变为规则。",
    inputAvailabilityTitle: "员工可用性",
    inputAvailabilityDesc: "班次只会落在每位员工给出的时间窗口内。没有登记可用性意味着永远不会被排班。同一次运行中已在其他门店预订的时间将被保留。",
    inputRolesTitle: "角色与技能等级",
    inputRolesDesc: "员工必须持有该班次的角色，或与之等效的角色。当多人符合条件时，优先考虑技能等级更高的员工。",
    inputHourRestrictionsTitle: "Hour Restrictions",
    inputHourRestrictionsDesc: "每位员工的每周工时上限，在同一次运行的所有门店中保持一致。",
    inputDayRulesTitle: "Day Rules",
    inputDayRulesDesc: "按星期几重复出现的禁排时段。排班器绝不会在其上安排班次。",
    inputMinRestTitle: "最短休息时间",
    inputMinRestDesc: "不同日期班次之间的门店级间隔，确保没有人打烊后又马上开门。",
    inputAssociationTitle: "Employee Association",
    inputAssociationDesc: "不能一起工作的员工对永远不会被安排在同一班次。必须一起工作、最好一起以及偏好分开的员工对，会引导谁被选中。",
    inputDayPrefsTitle: "日期偏好",
    inputDayPrefsDesc: "每位员工偏好星期几。",
    inputHourRangeTitle: "时段偏好",
    inputHourRangeDesc: "每位员工偏好一天中的哪些时段。当班次至少有一半落在该时段内时即计入。",
    inputFreqCapsTitle: "频率上限",
    inputFreqCapsDesc: "员工在给定时段内每周工作的次数。",
    inputsTemplatesNote: "班次模板和特定日期的覆盖项定义了需要填补的内容。每份草案在生成后都会重新验证，任何违反软性偏好的班次都会被标记以供审查。",
    inputsNotYet: "尚未考虑：薪资标准、加班津贴、工龄。最短休息时间是唯一内置的劳动法规则。",
