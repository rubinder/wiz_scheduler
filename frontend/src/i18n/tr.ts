const trLang = {
  ...
  approvedSchedules: {
    ...
    editTitle: "Vardiyayı Düzenle",
    readOnlyNotice: "Salt okunur — 30 günlük düzenleme süresi doldu.",
    savedWithWarnings: "Kaydedildi, uyarılarla birlikte",
    deletedWithWarnings: "Silindi, uyarılarla birlikte",
    warningAlreadyBookedTitle: "Çift rezervasyon",
    warningAlreadyBookedBody: "Bu çalışan zaten çakışan bir vardiyaya planlanmış.",
    warningNoAvailabilityTitle: "Müsaitlik kaydı yok",
    warningNoAvailabilityBody: "Bu çalışanın bu vardiyayı kapsayan kayıtlı bir müsaitliği yok.",
    warningAlreadyExportedTitle: "Zaten dışa aktarıldı",
    warningAlreadyExportedBody: "Bu program zaten dışa aktarıldı; harici sistem artık güncel olmayabilir.",
    shiftLockedTitle: "Vardiya kilitli",
    shiftLockedBody: "Bir çalışan bu vardiya için zaten giriş yaptı, bu yüzden artık düzenlenemez.",
    scheduleLockedTitle: "Program kilitli",
    scheduleLockedBody: "{name} şu anda bu programı düzenliyor. Kısa süre sonra tekrar deneyin.",
    invalidEdit: "Bu düzenleme uygulanamadı. Hiçbir şey değişmedi.",
  },
  ...
  schedule: {
    ...
    balanceLabel: "bakiye",
    includedThisMonth: "bu ay dahil",
    purchaseModalTitle: "AI kredileri",
    purchaseModalBody: "Krediler, AI ile Oluştur'u ve her ay dahil olan 50'nin ötesindeki programları öder. Paketler aboneliğinizdeki karttan tahsil edilir.",
    packButton: "{amount} Satın Al",
    autoReloadOptIn: "Bakiyem bittiğinde bu tutarı otomatik olarak yeniden yükle",
    purchaseDeclined: "Kartınız reddedildi. Manage billing üzerinden güncelleyip tekrar deneyin.",
    purchaseNoCard: "Kayıtlı kart yok. Manage billing üzerinden bir tane ekleyip tekrar deneyin.",
    purchaseOnHold: "Başarısız bir ödeme sonrası faturalama askıya alındı. Önce ödemeyi tekrar deneyin.",
    purchaseSuccess: "Krediler eklendi.",
    creditsExhaustedMsg: "AI ile Oluştur önceden ödenmiş kredilerle çalışır. Bakiyeniz boş — devam etmek için bir paket satın alın.",
    redirectingToPayment: "Redirecting...",
    schedulesUsed: "Schedules this month",
    scheduleFreeTierUsed: "Free tier exhausted",
    scheduleQuotaExhaustedMsg: "Bu ay dahil olan 50 programı kullandınız. Ek programlar aynı kredi bakiyesinden ödenir — devam etmek için bir paket satın alın.",
    autoReloadTitle: "Otomatik Yeniden Yükleme",
    autoReloadDescription: "İsteğe bağlı. Kredi bakiyeniz eşiğin altına düştüğünde, kayıtlı kartınızdan yeniden yükleme tutarını tahsil ederiz. Varsayılan olarak kapalıdır; her tahsilat sizin talep ettiğiniz bir tahsilattır.",
  ...
  landing: {
    ...
    pricePerMonth: "/ ay",
    basePlanDesc: "Sahiplik grubu başına temel abonelik. Ayda 50 çizelge, 0.5 GB depolama ve 1K çalışan içerir.",
    aiCredits: "AI kredi paketleri",
    aiPackFrom: "$10'dan başlayan",
    compSchedules: "Ücretsiz programlar / ay",
    storageIncluded: "Depolama dahil",
    employeesIncluded: "Çalışanlar dahil",
    normalStrategiesNote: "Rotation, Max Hours ve Random her zaman dahildir. AI oluşturma ön ödemeli kredi paketleriyle çalışır.",
    aiScheduling: "AI Planlama",
    included: "Dahil",
    overage: "Aşım",
    aiOverageNote: "Claude Sonnet 5 token maliyeti ($2/M giriş, $10/M çıkış) %130 ile, $10, $25 veya $50'lik ön ödemeli paketlerden düşülür.",
    ...
    exampleAICost: "Kredilerden $1.95",
    ...
    inputsHardHeading: "Her zaman uygulanır",
    inputsSoftHeading: "0 ile 1 arasında ağırlıklandırılır. 1,0'da bir tercih kurala dönüşür.",
    inputAvailabilityTitle: "Çalışan müsaitliği",
    inputAvailabilityDesc: "Vardiyalar yalnızca her çalışanın belirttiği zaman aralıklarına yerleşir. Kayıtlı müsaitlik olmaması, asla planlanmayacağı anlamına gelir. Aynı çalıştırmada başka bir lokasyonda zaten ayrılmış saatler tutulur.",
    inputRolesTitle: "Roller ve beceri seviyeleri",
    inputRolesDesc: "Bir çalışan, vardiyanın rolünü ya da buna eşdeğer bir rolü taşımalıdır. Birden fazla kişi uygun olduğunda daha yüksek beceri seviyeleri tercih edilir.",
    inputHourRestrictionsTitle: "Hour Restrictions",
    inputHourRestrictionsDesc: "Aynı çalıştırmadaki her lokasyonda korunan, çalışan başına haftalık saat sınırı.",
    inputDayRulesTitle: "Day Rules",
    inputDayRulesDesc: "Haftanın her günü için tekrarlanan yasak aralıklar. Planlayıcı bunun üzerine asla bir vardiya yerleştirmez.",
    inputMinRestTitle: "Minimum dinlenme",
    inputMinRestDesc: "Farklı günlerdeki vardiyalar arasında lokasyon başına boşluk, böylece kimse kapatıp hemen açmaz.",
    inputAssociationTitle: "Employee Association",
    inputAssociationDesc: "Birlikte çalışamayan çiftler asla aynı vardiyaya konulmaz. Birlikte çalışması gereken, iyi olur denen ve ayrı tutulması tercih edilen çiftler kimin seçileceğini yönlendirir.",
    inputDayPrefsTitle: "Gün Tercihleri",
    inputDayPrefsDesc: "Her çalışanın haftanın hangi günlerini tercih ettiği.",
    inputHourRangeTitle: "Saat Aralığı Tercihleri",
    inputHourRangeDesc: "Her çalışanın günün hangi saatlerini tercih ettiği. Bir vardiya, en az yarısı aralığa girdiğinde sayılır.",
    inputFreqCapsTitle: "Sıklık Sınırları",
    inputFreqCapsDesc: "Bir çalışanın belirli bir saat aralığında haftada kaç kez çalıştığı.",
    inputsTemplatesNote: "Vardiya şablonları ve belirli tarihe özgü geçersiz kılmalar, neyin doldurulması gerektiğini tanımlar. Her taslak, oluşturulduktan sonra yeniden doğrulanır ve yumuşak bir tercihe aykırı olan herhangi bir vardiya incelenmek üzere işaretlenir.",
    inputsNotYet: "Henüz dikkate alınmayanlar: ücret oranları, fazla mesai primleri, kıdem. Minimum dinlenme, yerleşik tek iş hukuku kuralıdır.",
