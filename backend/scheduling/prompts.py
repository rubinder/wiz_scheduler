...
def build_schedule_prompt(
    ...
    prompt = (
        ...
        f"7. An employee can only fill ONE role per shift. If an employee is qualified for multiple roles,\n"
        f"   do not assign them to overlapping shifts under different roles.\n"
        f"\n"
        f"Use the submit_schedule tool to return your schedule."
    )
    return prompt
