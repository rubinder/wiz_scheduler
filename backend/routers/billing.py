    ...
    if not og_id:
        return {
            ...
            "llm": {"input_tokens": 0, "output_tokens": 0, "raw_cost_usd": 0, "charged_usd": 0,
                     "included_usd": settings.INCLUDED_LLM_USD, "included_remaining_usd": settings.INCLUDED_LLM_USD,
                     "is_over_included": False, "overage_markup": settings.LLM_OVERAGE_MARKUP},
            "storage": {"used_gb": 0, "free_gb": settings.INCLUDED_STORAGE_GB, "billable_gb": 0,
                        "cost_per_gb": settings.STORAGE_COST_PER_GB, "charged_usd": 0},
            "employees": {"count": 0, "free_tier": settings.INCLUDED_EMPLOYEES, "billable": 0,
                          "block_size": settings.EMPLOYEE_BLOCK_SIZE, "cost_per_block": settings.EMPLOYEE_COST_PER_BLOCK, "charged_usd": 0},
            "schedules": {"count": 0, "free_tier": settings.INCLUDED_SCHEDULES_PER_MONTH, "billable": 0,
